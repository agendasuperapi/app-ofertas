    ...
    <div className={`absolute inset-0 overflow-hidden ${className}`}>
      ...
      <div className={`absolute inset-0 
        ${isDark 
          ? (isNeutralDark 
            ...
            : 'dark:bg-gradient-to-b dark:from-primary/10 dark:via-slate-950 dark:to-slate-950 bg-gradient-to-b from-orange-200/30 via-orange-50 to-white') 
      ...
      <div className={`absolute top-0 left-0 right-0 h-[60vh] md:h-[80vh] 
        ${isDark 
          ? (isNeutralDark 
            ...
            : 'dark:bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,hsl(var(--primary)/0.20),transparent)] bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,hsl(30_100%_60%/0.25),transparent)]') 
        ...
        className={`absolute -top-20 left-1/2 -translate-x-1/2 w-80 h-80 md:w-[600px] md:h-[400px] 
          ${isDark 
            ? (isNeutralDark 
              ...
              : 'dark:bg-gradient-to-b dark:from-primary/25 dark:via-orange-500/20 dark:to-transparent bg-gradient-to-b from-orange-400/40 via-amber-300/30 to-transparent') 
      ...
      <motion.div 
        className={`absolute top-1/4 -left-16 md:-left-32 w-64 h-64 md:w-[500px] md:h-[500px] 
          ${isDark 
            ? 'dark:bg-gradient-to-r dark:from-cyan-500/20 dark:to-blue-500/15 bg-gradient-to-r from-orange-400/30 to-amber-400/25' 
        ...
        className={`absolute bottom-1/4 -right-16 md:-right-32 w-72 h-72 md:w-[600px] md:h-[600px] 
          ${isDark 
            ? (isNeutralDark 
              ...
              : 'dark:bg-gradient-to-l dark:from-primary/20 dark:to-orange-500/15 bg-gradient-to-l from-amber-400/30 to-orange-400/25') 
        ...
        className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 md:w-[800px] md:h-[800px] 
          ${isDark 
            ? (isNeutralDark 
              ...
              : 'dark:bg-gradient-radial dark:from-primary/8 dark:to-transparent bg-gradient-radial from-orange-300/15 to-transparent') 
      ...
      <motion.div 
        className="absolute top-1/3 right-1/4 w-48 h-48 md:w-[300px] md:h-[300px] dark:bg-gradient-to-br dark:from-cyan-500/15 dark:to-transparent bg-gradient-to-br from-amber-400/20 to-transparent rounded-full blur-[80px] hidden dark:block"
        animate={{ 
          scale: [1, 1.15, 1],
          opacity: [0.2, 0.4, 0.2],
        }}
      ...
      {[...Array(15)].map((_, i) => (
        <motion.div
          ...
          className={`absolute w-1 h-1 rounded-full 
            ${i % 2 === 0 
              ? 'dark:bg-primary/50 bg-orange-500/50' 
              : 'dark:bg-cyan-500/50 bg-amber-500/50'
            }`}
          style={{
