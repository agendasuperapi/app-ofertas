      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-white">
            Escolha o plano{' '}
            <span className="bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 dark:from-primary dark:via-orange-500 dark:to-cyan-500 bg-clip-text text-transparent">
              ideal para você
            </span>
          </h2>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-6">
                      <div className="flex items-baseline gap-1">
                        <span className="text-slate-500 dark:text-slate-400 text-lg">R$</span>
        ...
        {/* Trust note */}
        <motion.p 
          className="text-center text-slate-500 dark:text-slate-500 text-sm mt-8"
          initial={{ opacity: 0 }}
