            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                ...
                <span className="relative">
                  <span className="bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 dark:from-primary dark:via-orange-500 dark:to-cyan-500 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">
                    Sucesso Digital
                  </span>
                  <motion.span 
                    className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 dark:from-primary dark:via-orange-500 dark:to-cyan-500 rounded-full" 
                    initial={{ scaleX: 0 }} 
                    animate={{ scaleX: 1 }} 
              ...
              <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 mb-8 max-w-xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                <Button asChild size="lg" className="text-lg px-8 py-6 bg-gradient-to-r from-orange-500 to-amber-500 dark:from-primary dark:to-orange-500 hover:from-orange-600 hover:to-amber-600 dark:hover:from-primary/90 dark:hover:to-orange-500/90 shadow-lg shadow-orange-500/30 dark:shadow-primary/30 group relative overflow-hidden">
                  <Link to="/become-partner">
                    ...
                    <motion.div 
                      className="absolute inset-0 bg-gradient-to-r from-amber-500 to-orange-500 dark:from-orange-500 dark:to-primary" 
                      initial={{ x: '100%' }} 
                      whileHover={{ x: 0 }} 
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 dark:from-primary dark:via-orange-500 dark:to-cyan-500 bg-clip-text text-transparent">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold mb-2">
              Sua loja em{' '}
              <span className="bg-gradient-to-r from-orange-500 to-amber-500 dark:from-primary dark:to-cyan-500 bg-clip-text text-transparent">
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <Badge className="mb-4 bg-cyan-100 text-cyan-600 border-cyan-200 dark:bg-cyan-500/20 dark:text-cyan-400 dark:border-cyan-500/30">
              Como Funciona
            </Badge>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              4 passos simples para{' '}
              <span className="bg-gradient-to-r from-cyan-500 to-blue-500 dark:from-cyan-400 dark:to-blue-500 bg-clip-text text-transparent">
                começar a vender
              </span>
            </h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg max-w-2xl mx-auto">
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="text-center group">
                  <motion.div 
                    className="w-28 h-28 mx-auto mb-6 rounded-full bg-white/80 dark:bg-slate-900/80 border-2 border-cyan-300/50 dark:border-cyan-500/30 flex items-center justify-center relative overflow-hidden group-hover:border-cyan-500/60 transition-colors" 
                  ...
                  >
                    ...
                    <span className="text-4xl font-bold bg-gradient-to-r from-cyan-500 to-blue-500 dark:from-cyan-400 dark:to-blue-500 bg-clip-text text-transparent relative z-10">
                      {step.number}
                    </span>
                  </motion.div>
                  <h3 className="font-bold text-xl mb-2 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors text-slate-900 dark:text-white">{step.title}</h3>
      ...
      <section className="py-24 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <Badge className="mb-4 bg-purple-100 text-purple-600 border-purple-200 dark:bg-purple-500/20 dark:text-purple-400 dark:border-purple-500/30">
              Dashboard Completo
            </Badge>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              Tudo que você precisa em{' '}
              <span className="bg-gradient-to-r from-purple-500 to-pink-500 dark:from-purple-400 dark:to-pink-500 bg-clip-text text-transparent">
                um só lugar
              </span>
            </h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <Badge className="mb-4 bg-green-100 text-green-600 border-green-200 dark:bg-green-500/20 dark:text-green-400 dark:border-green-500/30">
                <Users className="w-4 h-4 mr-2" />
                Sistema de Afiliados
              </Badge>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
                Transforme clientes em{' '}
                <span className="bg-gradient-to-r from-green-500 to-emerald-500 dark:from-green-400 dark:to-emerald-500 bg-clip-text text-transparent">
                  vendedores
                </span>
              </h2>
                ...
                {affiliateFeatures.map((feature, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 dark:text-slate-500 text-xs">{feature.description}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <motion.div 
              ...
              className="relative"
            >
              <GlassCard hoverEffect={false} variant="dark" className="bg-gradient-to-br from-green-100/50 to-emerald-100/50 dark:from-green-500/10 dark:to-emerald-500/10 border-green-300/50 dark:border-green-500/30">
                <div className="p-8 space-y-6">
                  <div className="flex items-center justify-between p-4 bg-white/80 dark:bg-slate-900/80 rounded-xl border border-green-200/50 dark:border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-slate-900 dark:text-white">Felipe Afiliado</p>
                        <p className="text-xs text-slate-500 dark:text-slate-400">Cupom: FELIPE</p>
                      </div>
                    </div>
                    <Badge className="bg-green-100 text-green-600 border-green-200 dark:bg-green-500/20 dark:text-green-400 dark:border-green-500/30">Ativo</Badge>
                  </div>
                  
                  <div className="grid grid-cols-2 gap-4">
                    <motion.div 
                      className="p-4 bg-white/80 dark:bg-slate-900/80 rounded-xl text-center border border-green-200/50 dark:border-white/10" 
                    ...
                    >
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400">Comissões (15%)</p>
                    </motion.div>
                  </div>

                  <div className="p-4 bg-white/80 dark:bg-slate-900/80 rounded-xl border border-green-200/50 dark:border-white/10">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-sm text-slate-600 dark:text-slate-400">Disponível para saque</span>
                      <span className="font-bold text-green-600 dark:text-green-400 text-lg">R$ 245,00</span>
                    </div>
          ...
          <div className="relative overflow-hidden py-4 space-y-4">
            ...
            >
              {[...categories, ...categories, ...categories].map((category, index) => (
                ...
                >
                  <div className="flex items-center gap-3 px-6 py-3 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-full border border-cyan-200/50 dark:border-white/10 hover:border-cyan-400/50 dark:hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-200/20 dark:hover:shadow-cyan-500/10 transition-all duration-300 cursor-pointer group">
                    <category.icon className="h-5 w-5 text-cyan-600 dark:text-cyan-400 group-hover:scale-110 transition-transform" />
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <Badge className="mb-4 bg-yellow-100 text-yellow-600 border-yellow-200 dark:bg-yellow-500/20 dark:text-yellow-400 dark:border-yellow-500/30">
              <Star className="w-4 h-4 mr-2 fill-yellow-500 dark:fill-yellow-400" />
              Depoimentos
            </Badge>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              O que nossos{' '}
              <span className="bg-gradient-to-r from-yellow-500 to-orange-500 dark:from-yellow-400 dark:to-orange-500 bg-clip-text text-transparent">
                clientes dizem
              </span>
            </h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg">
      ...
      <section className="py-24 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <Badge className="mb-4 bg-indigo-100 text-indigo-600 border-indigo-200 dark:bg-indigo-500/20 dark:text-indigo-400 dark:border-indigo-500/30">
              FAQ
            </Badge>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              Perguntas{' '}
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  <AccordionContent className="text-slate-600 dark:text-slate-400 pb-5 text-base leading-relaxed">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg sm:text-xl mb-10 max-w-2xl mx-auto">
            ...
            {/* Final trust badges */}
            <motion.div 
              className="mt-12 flex flex-wrap justify-center gap-6 text-sm text-slate-500 dark:text-slate-500" 
              initial={{ opacity: 0 }} 
              whileInView={{ opacity: 1 }} 
              viewport={{ once: true }} 
              transition={{ delay: 0.3 }}
            >
              {['Sem cartão de crédito', 'Cancele quando quiser', 'Suporte em português'].map((text, i) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-2 md:col-span-1">
              <Link to="/" className="text-2xl font-bold bg-gradient-to-r from-orange-500 to-amber-500 dark:from-primary dark:to-cyan-500 bg-clip-text text-transparent">
                Ofertas.app
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-500 dark:text-slate-500 text-sm">
                <li><Link to="/become-partner" className="hover:text-orange-500 dark:hover:text-primary transition-colors">Criar Loja</Link></li>
                <li><Link to="/heymax" className="hover:text-orange-500 dark:hover:text-primary transition-colors">Ver Demo</Link></li>
                <li><a href="#" className="hover:text-orange-500 dark:hover:text-primary transition-colors">Preços</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-slate-900 dark:text-white">Recursos</h4>
              <ul className="space-y-2 text-slate-500 dark:text-slate-500 text-sm">
                <li><a href="#" className="hover:text-orange-500 dark:hover:text-primary transition-colors">Blog</a></li>
                <li><a href="#" className="hover:text-orange-500 dark:hover:text-primary transition-colors">Central de Ajuda</a></li>
                <li><a href="#" className="hover:text-orange-500 dark:hover:text-primary transition-colors">API</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-slate-900 dark:text-white">Contato</h4>
              <ul className="space-y-2 text-slate-500 dark:text-slate-500 text-sm">
                <li><a href="mailto:contato@ofertas.app" className="hover:text-orange-500 dark:hover:text-primary transition-colors">contato@ofertas.app</a></li>
                <li><a href="#" className="hover:text-orange-500 dark:hover:text-primary transition-colors">WhatsApp</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-orange-200/50 dark:border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-slate-500 dark:text-slate-500 text-sm">
              <a href="#" className="hover:text-orange-500 dark:hover:text-primary transition-colors">Termos de Uso</a>
              <a href="#" className="hover:text-orange-500 dark:hover:text-primary transition-colors">Privacidade</a>
            </div>
          </div>
        </div>
      </footer>
