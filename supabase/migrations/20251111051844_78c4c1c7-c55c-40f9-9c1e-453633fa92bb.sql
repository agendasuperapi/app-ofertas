...
-- Recriar a função para forçar reload do PostgREST
DROP FUNCTION IF EXISTS public.create_order_rpc(uuid, text, text, text, text, numeric, numeric, numeric, text, text, text, text, text, numeric, text) CASCADE;
...
GRANT EXECUTE ON FUNCTION public.create_order_rpc TO anon;
